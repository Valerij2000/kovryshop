                    ...
                    <div id="gallery-1" class="royalSlider rsUni">
                            <?php 
                                function showTumbnlCardsGoods ($cards) {
                                    for ($i = 1; $i <= $cards; $i++) { ?>
                                        <a class="rsImg" href="assets/img/carpet-catalog/<?php echo $i?>.jpg" data-rsw="500" data-rsh="500"> <img class="rsTmb" src="assets/img/carpet-catalog/<?php echo $i + mt_rand(1, 10); ?>.jpg" alt="Products goods"></a>
