            ...
            <div class="diblock">
                <div class="col-lg-6 col-sm-12 col-xs-12">
                    <div id="gallery-1" class="royalSlider rsUni">
                        ...
                        {
                            for ($i = 1; $i <= $cards; $i++) { ?>
                                <a class="rsImg" href="assets/img/liner-catalog/<?php echo $i + mt_rand(1, 10); ?>.jpg" data-rsw="500" data-rsh="500"> <img class="rsTmb" src="assets/img/liner-catalog/<?php echo $i + mt_rand(1, 10); ?>.jpg" alt="Products goods"></a>
                        <?php }
                        }
