                ...
                <div class="tab-content">
                    ...
                    <div id="grid-view" class="tab-pane fade active in" role="tabpanel">
                        <div class="row text-center hvr2 clearfix">
                            <?php $request = mysqli_query($mysql, "SELECT * FROM `goods_carpet_page_two` ");
                            while ($goods_carpet_page_two = mysqli_fetch_assoc($request)) { ?>
                                <div class="col-md-3 col-sm-4">
                                    <div class="portfolio-wrapper">
                                        <div class="portfolio-thumb">
                                            <img class="img__item" src="<?php echo $goods_carpet_page_two['image']; ?>" alt="">
                                        ...
                                        <div class="product-content">
                                            <h3> <a class="title-3 fsz-16" href="#"> <?php echo $goods_carpet_page_two['title']; ?> </a> </h3>
                                            <p class="font-3">Цена: <span class="thm-clr"> <?php echo $goods_carpet_page_two['price']; ?> руб.</span> </p>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
                        ...
                        <nav class="woocommerce-pagination">
                            <ul class="page-numbers">
                                <li><a class="next page-numbers" href="category-carpet-page-one.php"> <i class="fa fa-angle-left"></i> </a></li>
